...
import com.library.library.pojo.IdCard;
...
public class IdCardService {
     ...
     */
    public static String getIdCardDetail(String cardNo, usersn usersn) throws UnsupportedEncodingException{
        // 获取身份证信息
        ...
        if (idcard != null) {
            ...
            usersn.setGender(idcard.getSex());
